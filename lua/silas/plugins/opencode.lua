return {
  ...
  config = function()
    ...
    vim.keymap.set({ "n", "x" }, "<leader>ot", function() require("opencode").ask("@this: ", { submit = true }) end, { desc = "Ask opencode…" })
    vim.keymap.set({ "n", "x" }, "<leader>oa", function() require("opencode").ask("", { submit = true}) end, { desc = "Ask opencode…" })
